...
// Spread tool icon
export const SpreadNone: IIcon = props => (
  <Icon {...props}>
...
export const SpreadBasic: IIcon = props => (
  <Icon {...props}>
    <path d="M3,11H11V3H3M3,21H11V13H3M13,21H21V13H13M13,3V11H21V3" />
  </Icon>
)

export const SpreadShift: IIcon = props => (
  <Icon {...props}>
...
// Info tool icon
export const InfoNone: IIcon = props => (
  <Icon {...props}>
    <path d="M11,9H13V7H11M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M11,17H13V11H11V17Z" />
  </Icon>
)

export const InfoActive: IIcon = props => (
  <Icon {...props}>
...
// Like tool icon
export const LikeNone: IIcon = props => (
  <Icon {...props}>
    <path d="M5,9V21H1V9H5M9,21A2,2 0 0,1 7,19V9C7,8.45 7.22,7.95 7.59,7.59L14.17,1L15.23,2.06C15.5,2.33 15.67,2.7 15.67,3.11L15.64,3.43L14.69,8H21C22.11,8 23,8.9 23,10V12C23,12.26 22.95,12.5 22.86,12.73L19.84,19.78C19.54,20.5 18.83,21 18,21H9M9,19H18.03L21,12V10H12.21L13.34,4.68L9,9.03V19Z" />
  </Icon>
)

export const LikeActive: IIcon = props => (
  <Icon {...props}>
...
// Tweet tool icon
export const Tweet: IIcon = props => (
  <Icon {...props}>
...
// Download tool icon
export const Download: IIcon = props => (
  <Icon {...props}>
...
export const Description = InfoActive

export const ViewCount: IIcon = props => (
  <Icon {...props}>
...
export const RateCount = LikeActive

export const Caption: IIcon = props => (
  <Icon {...props}>
    <path d="M14 17H4v2h10v-2zm6-8H4v2h16V9zM4 15h16v-2H4v2zM4 5v2h16V5H4z" />
  </Icon>
)

export const Tag: IIcon = props => (
  <Icon {...props}>
...
export const Info = InfoActive

export const Bug: IIcon = props => (
  <Icon {...props}>
...
// Setting item icon
export const Check: IIcon = props => (
  <Icon {...props}>
    <path d="M10,17L5,12L6.41,10.58L10,14.17L17.59,6.58L19,8M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z" />
  </Icon>
)

export const UnCheck: IIcon = props => (
  <Icon {...props}>
    <path d="M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3M19,5V19H5V5H19Z" />
  </Icon>
)

export const Padding: IIcon = props => (
  <Icon {...props}>
