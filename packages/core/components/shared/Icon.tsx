...
export const CheckboxOff = (props: Props) => (
  <Svg aria-hidden={true} {...props}>
    <Path d="M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3M19,5V19H5V5H19Z" />
  </Svg>
)
export const CheckboxOn = (props: Props) => (
  <Svg aria-hidden={true} {...props}>
...
export const Spread = (props: Props) => (
  <Svg aria-hidden={true} {...props}>
    <Path d="M3,11H11V3H3M3,21H11V13H3M13,21H21V13H13M13,3V11H21V3" />
  </Svg>
)
export const SpreadNone = (props: Props) => (
  <Svg aria-hidden={true} {...props}>
...
export const SpreadShift = (props: Props) => (
  <Svg aria-hidden={true} {...props}>
...
export const ViewCount = (props: Props) => (
  <Svg aria-hidden={true} {...props}>
...
export const AccountError = (props: Props) => (
  <Svg aria-hidden={true} {...props}>
    <Path d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z" />
    <Path
...
const Svg = styled.svg`
  ...
  fill: ${({ c = 'default' }: SvgProps) => colors[c]};
  flex-shrink: 0;
...
const Path = styled.path`
  fill: ${({ c = 'inherit' }: PathProps) => colors[c]};
`
