...
declare namespace Pixiv {
  ...
  /**
   * 追加情報
   * - IllustInfo.extraData
   * - RecentWorks.extraData
   */
  interface ExtraData {
    /** ヘッダタグ内の情報 */
    meta: Meta
  ...
  /**
   * イメージレスポンス
   * - IllustInfo.imageResponseData[n]
   */
  ...
  /**
   * 簡易版イラスト情報
   * - IllustInfo.userIllusts[illustId]
   */
  ...
  /**
   * タイトル翻訳情報
   * - IllustInfo.titleCaptionTranslation
  ...
  /**
   * Twitter Cards
   * - Meta.twitter: イラストページの Twitter Cards
   * - Meta.twitter: ユーザーページの Twitter Cards
   */
  interface Twitter {
